  ...
  return (
    <div className="flex flex-col items-center gap-4 p-4">
      <button
        ...
        disabled={uploading}
        className="pointer z-10 mt-6 rounded-lg border border-black bg-black px-3 py-2 text-sm font-semibold text-[#F9F6EE] transition hover:bg-[#b49ccc] hover: md:mt-4 hover:text-[#F9F6EE] hover:border-[#b49ccc] disabled:bg-[#ff746c]"
      >
